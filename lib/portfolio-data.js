...
export const profile = {
  ...
  phone: "+91 9205340375",
  linkedin: "https://www.linkedin.com/in/pradeepawasthi",
  github: "https://github.com/pradeepawasthi",
  resumeUrl: "https://customer-assets.emergentagent.com/job_ai-portfolio-144/artifacts/9hd0gszw_Pradeep_Resume%20%281%29.pdf",
  photo: "https://customer-assets.emergentagent.com/job_ai-portfolio-144/artifacts/ohovtm6n_1772340435105.jpg",
  stats: [
    { label: "Years of Experience", value: "14+" },
    { label: "Team Size Led", value: "40+" },
    { label: "Test Cases Automated", value: "10K+" },
    { label: "Regression Time Cut", value: "50%+" },
    { label: "Prod Defects Reduced", value: "10%→2%" },
    { label: "Cloud Cost Reduced", value: "25%" },
  ],
};

export const about = {
  summary: `Strategic Engineering Leader driving enterprise DevSecOps transformation, cloud modernization, and AI-driven automation. Proven track record managing cross-functional engineering teams of 40+ to deliver secure, scalable cloud-native platforms across AWS, Azure and GCP.`,
  paragraphs: [
